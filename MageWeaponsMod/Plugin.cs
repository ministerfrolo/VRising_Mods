...
public class Plugin : BasePlugin
{
    ...
    // ///
    // /// .mageweaponsmod-example "some quoted string" 1 1.5
    // /// .mageweaponsmod-example boop 21232
    // /// .mageweaponsmod-example boop-boop
    // ///</remarks>
    // [Command("mageweaponsmod-example", description: "Example command from mageweaponsmod", adminOnly: true)]
